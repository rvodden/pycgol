...
class TestGlider:
    ...
    def test_glider_placement_near_boundary(self):
        ...
        expected_cells = [
            (7, 7),
            (8, 7),
            (9, 7),  # bottom row (all within bounds)
    ...
    def test_glider_placement_partial_out_of_bounds(self):
        ...
        expected_cells = [
            (3, 3),
            (4, 3),  # Only these two cells are within bounds
        ]
    ...
    def test_glider_cells_constant(self):
        ...
        expected_pattern = [(0, 0), (1, 0), (2, 0), (2, 1), (1, 2)]
    ...
    def test_multiple_glider_placements(self):
        ...
        # Place two gliders
        glider1 = Glider()
        glider1.place((1, 1), state)
        glider2 = Glider()
        glider2.place((8, 8), state)
